...
import {
  SiTailwindcss, SiMongodb, SiPostman, SiExpress, SiCplusplus, SiJavascript
} from "react-icons/si";
...
const skillsData = [
  ...
  { name: "C++", icon: <SiCplusplus />, level: 65, category: "languages" },
  { name: "Python", icon: <FaPython />, level: 60, category: "languages" },
  { name: "Git & GitHub", icon: <FaGitAlt />, level: 85, category: "tools" },
  { name: "Postman", icon: <SiPostman />, level: 70, category: "tools" },
  { name: "VS Code", icon: <FaCode />, level: 95, category: "tools" },  // Updated to FaCode
  { name: "Figma", icon: <FaFigma />, level: 60, category: "design" },
];

const categories = ["all", "frontend", "backend", "languages", "tools", "design"];
